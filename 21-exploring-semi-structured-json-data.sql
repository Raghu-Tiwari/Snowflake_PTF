...
-- 21.0.0  Exploring Semi-Structured JSON Data
...
-- 21.1.0  Query Simple JSON Data Using Dot Notation Syntax

-- 21.1.1  Make sure you have the required objects and set your context for this
--         lab.
...
-- 21.1.2  Create a table with JSON data.
...
-- 21.1.3  Open a row of the table you just created to see its structure.
...
-- 21.1.4  Extract the name data from your table using dot notation syntax.
...
-- 21.1.5  Determine the data types in your result set.
...
-- 21.1.6  Rerun the query and examine the output.
...
-- 21.1.7  Extract the name data and cast it to type VARCHAR.
...
-- 21.1.8  Create a table from your query.
...
-- 21.2.0  Query Nested JSON Data with Dot Notation
...
-- 21.2.1  Create a new version of your customers table with various levels of
--         nested JSON data.
...
-- 21.2.2  Select from your table and click a cell in the INFO column to view
--         the structure.
...
-- 21.2.3  Query the table to fetch business and personal phone numbers.
...
-- 21.2.4  Fetch all data and put it in structured format.
...
-- 21.3.0  Use FLATTEN to Query JSON Data
...
-- 21.3.1  Use the FLATTEN function to view your table’s top-level keys.
...
-- 21.3.2  Use the RECURSIVE option to view all the keys from your table.
...
-- 21.3.3  Show only the keys that have simple values.
...
-- 21.3.4  Include the column this in your query.
...
-- 21.3.5  Include the path column in your query.
...
-- 21.3.6  Include the seq column in your query.
...
-- 21.3.8  Fetch ID, first name, last name, and business details.
...
-- 21.3.9  Fetch ID, first name, last name, and personal details.
--         Run the statement below:
...
-- 21.3.10 Fetch all contact details.
...
CREATE OR REPLACE SCHEMA LEARNER_DB.WEATHER;
USE SCHEMA LEARNER_DB.WEATHER;


-- 21.4.2  Run the statement below to create the data you’ll query.
...
-- 21.4.3  Take a look at the following diagram to better understand the data
--         you just created.
...
-- 21.4.4  Select USAF, WBAN, country, elev, id, and name from station using dot
--         notation.

-- 21.4.5  Select average, max, and min air temperature using LATERAL FLATTEN.

-- 21.4.6  Select max and min atmospheric pressure using LATERAL FLATTEN.

-- 21.4.7  Use either dot notation or FLATTEN LATERAL to fetch the dew point,
--         atmospheric pressure, and wind speed rate for the 15th observation.

-- 21.4.8  Check the solution just after the Key Takeaways if you need help.
--         Otherwise congratulations! You’ve just completed this lab.

-- 21.5.0  Key Takeaways
...
-- Dot notation:
 ...
 SELECT 
        ...
        wd.w:data.observations[14].wind."speed-rate"::NUMBER(38,1) AS dew_point
...
-- 21.7.0  Return to the Lab Exercise Page in the Course and Click the Mark as
--         complete Button
